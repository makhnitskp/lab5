		...
		if (mid1 < mid2)
			if(mid1<mid3)
				if(mid2<mid3)
					...
					System.out.println("mid1<mid3<mid2");
			else if (mid2==mid3)
					System.out.println("mid1<mid3=mid2");
		else if (mid2 < mid1)
			if(mid2<mid3)
				if(mid1<mid3)
					System.out.println("mid2<mid1<mid3");
			else if (mid1>mid3)
					System.out.println("mid2<mid3<mid1");
			else if (mid1==mid3)
					System.out.println("mid2<mid3=mid1");
		else if (mid3 < mid1)
			if(mid3<mid2)
				if(mid2<mid1)
					System.out.println("mid3<mid2<mid1");
			else if (mid2>mid1)
					System.out.println("mid3<mid1<mid2");
			else if (mid2==mid1)
					System.out.println("mid3<mid1=mid2");
	    else if (mid2 == mid1)
			if(mid2<mid3)
